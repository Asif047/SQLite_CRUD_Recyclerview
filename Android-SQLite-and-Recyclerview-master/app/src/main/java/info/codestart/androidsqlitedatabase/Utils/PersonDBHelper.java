...
public class PersonDBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL(" CREATE TABLE " + TABLE_NAME + " (" +
                ...
                COLUMN_PERSON_OCCUPATION + " DOUBLE NOT NULL, " +
    ...
    public List<Person> peopleList(String filter) {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                person.setOccupation(Double.valueOf(cursor.getString(cursor.getColumnIndex(COLUMN_PERSON_OCCUPATION))));
    ...
    public Person getPerson(long id){
        ...
        if(cursor.getCount() > 0) {
            ...
            receivedPerson.setOccupation(Double.valueOf(cursor.getString(cursor.getColumnIndex(COLUMN_PERSON_OCCUPATION))));
